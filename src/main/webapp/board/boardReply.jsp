...
<body>
   ...
   <table>
      ...
      <tr>
         ...
         <input type="submit" class="my-button" value="답변 등록"
         onclick="return go_fbw2()()"> 
         <input type="reset"   class="my-button" value="다시 작성"> 
         <input type="button" class="my-button" value="목록" 
         onclick="location.href='NutsServlet?command=board_list'">
